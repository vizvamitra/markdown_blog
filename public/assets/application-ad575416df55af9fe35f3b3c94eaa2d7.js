...
(function() {
  $(function() {
    return $('#comment_form input[type=submit]').click(function(e) {
      var form;
      e.stopPropagation();
      e.preventDefault();
      form = $('#new_comment');
      if (form.find('#comment_author').val() === '') {
        return form.find('#error').html('Представтесь пожалуйста');
      } else if (form.find('#comment_body').val() === '') {
        return form.find('#error').html('Вы забыли написать текст комментария');
      } else {
        return form.submit();
      }
    });
...
(function() {
  $(document).on('page:change', function() {
    ...
    $('#post_body_div').keydown(function(e) {
      if (e.which === 13) {
        e.preventDefault();
    ...
    $('.post_form input[type=submit]').click(function(e) {
      ...
      if (body === '') {
        return form.find('#error').html('<h4>Но вы же ничего не написали!</h4>');
      } else if (form.find('#post_title').val() === '') {
        return form.find('#error').html('<h4>Посту нужно название!</h4>');
      } else {
    ...
    return $('#show_markdown_help').click(function(e) {
      e.preventDefault();
      e.stopPropagation();
      $('#markdown_help').show();
      $('body').click(function() {
        return $('#markdown_help').hide();
      });
      return $('#markdown_help').click(function(e) {
        e.stopPropagation();
  ...
  $.fn.paste_in_position = function(text_to_paste) {
